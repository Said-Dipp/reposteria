...
class CategoriaProductoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('categoriaproducto.index', compact('categoriaproducto'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/categoriaproducto')->with('flash_message', 'CategoriaProducto added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/categoriaproducto')->with('flash_message', 'CategoriaProducto updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/categoriaproducto')->with('flash_message', 'CategoriaProducto deleted!');
    }
}
