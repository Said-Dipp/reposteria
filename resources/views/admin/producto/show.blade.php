            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/producto/' . $producto->id . '/edit') }}" title="Edit Producto"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Nombre </th><td> {{ $producto->nombre }} </td></tr><tr><th> Costo </th><td> {{ $producto->costo }} </td></tr><tr><th> Cantidad </th><td> {{ $producto->cantidad }} </td></tr>
                                </tbody>
                            </table>
                        </div>
