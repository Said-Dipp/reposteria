            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/venta/' . $ventum->id . '/edit') }}" title="Edit Ventum"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Fecha </th><td> {{ $ventum->fecha }} </td></tr><tr><th> Hora </th><td> {{ $ventum->hora }} </td></tr><tr><th> Total </th><td> {{ $ventum->total }} </td></tr>
                                </tbody>
                            </table>
                        </div>
